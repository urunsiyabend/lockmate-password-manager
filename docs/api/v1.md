...
Security endpoints surface potential risks in stored credentials.
...
**Successful response — 201 Created** returns the stored item with system metadata.
...
**Successful response — 200 OK** returns the updated share record.
